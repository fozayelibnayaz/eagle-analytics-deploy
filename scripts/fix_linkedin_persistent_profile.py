...
new_func = f'''def {func_name}(headless=False):
    """
    Use the SAME persistent Chrome profile created by save_linkedin_session_state.py.
    This is more reliable for LinkedIn admin analytics than storage_state replay.
    """
    from pathlib import Path
